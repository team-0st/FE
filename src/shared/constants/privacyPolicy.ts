...
export const SERVICE_CONSENT_NOTICE = {
    ...
    items:
        '닉네임, 휴대전화번호, 비밀번호(일방향 암호화 저장), 단골·제휴 샵 선택 정보, 미션·출석·가챠·스프·재료 등 이용 기록, 미션 인증을 위해 업로드한 사진, 앱 이용 과정에서 생성되는 로그·오류 정보',
...
export const SERVICE_CONSENT_SUMMARY = {
    ...
    items: '닉네임, 휴대전화번호, 비밀번호(일방향 암호화 저장), 이용 기록, 인증 사진 등',
...
export const PRIVACY_POLICY_SECTIONS: PrivacyPolicySection[] = [
    ...
    },
    {
        ...
        paragraphs: [
            ...
            '수집 방법: 이용자 입력, 미션 인증 사진 업로드, 서비스 이용 과정에서 자동 생성(이용 기록·오류 로그 등).',
        ],
    },
    {
    ...
    },
    {
        ...
        paragraphs: [
            ...
            '현재 제로스트가 직접 수집하는 휴대전화번호는 계정 로그인에 필수로 이용해요.',
            '알맹상점 매장 포인트 연동에는 별도 선택 동의한 경우에만 이용하며, 토스 인증 계약·연동 전에는 토스 인증 API로 전송하지 않아요.',
        ],
    },
    {
