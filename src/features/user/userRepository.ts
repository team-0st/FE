...
export async function loadUserState(): Promise<AppUserState> {
    ...
    return {
        ...
        locationConsent: rest.locationConsent ?? null,
        locationConsentAt: rest.locationConsentAt ?? null,
        cameraConsent: rest.cameraConsent ?? null,
        cameraConsentAt: rest.cameraConsentAt ?? null,
        lastCheckInDate,
        checkInDates,
